...
auther: yutanbird
cover: https://imagere.oss-cn-beijing.aliyuncs.com/img20220904/20221201205704.png
excerpt: 腾讯AI接口实例，使用到了自动回复AI，语音转文字AI，文字转语音AI，然后综合成一个聊天机器人
permalink: /archives/teng-xun-ai-jie-kou-shi-li
categories:
 - spider
tags: 
 - python
